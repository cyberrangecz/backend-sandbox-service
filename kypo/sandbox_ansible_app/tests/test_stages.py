...
from kypo.sandbox_ansible_app.views import NetworkingAnsibleAllocationStageDetail
...
class TestStages:
    ...
    def test_networking_stage_views(self, arf):
        ...
        response = NetworkingAnsibleAllocationStageDetail.as_view()(request, request_id=ALLOCATION_REQUEST_ID)
