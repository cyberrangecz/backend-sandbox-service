...
def connect_to_jump():
    hostname = settings.KYPO_CONFIG.proxy_jump_to_man.Host
    user = settings.KYPO_CONFIG.proxy_jump_to_man.User
    identity_file = settings.KYPO_CONFIG.proxy_jump_to_man.IdentityFile
    port = 22
