    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'allocation_request_fk_many',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='stages',
                        to='sandbox_instance_app.AllocationRequest',
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'cleanup_request_fk_many',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='stages',
                        to='sandbox_instance_app.CleanupRequest',
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(help_text='Private key for management access.'),
                ),
                (
                    'public_management_key',
                    models.TextField(help_text='Public key for management access.'),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to='sandbox_definition_app.Definition',
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    'id',
                    models.PositiveIntegerField(default=-1024, primary_key=True, serialize=False),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name='rq_job',
                        serialize=False,
                        to='sandbox_instance_app.AllocationStage',
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name='rq_job',
                        serialize=False,
                        to='sandbox_instance_app.CleanupStage',
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                to='sandbox_instance_app.SandboxAllocationUnit',
            ),
        ),
        migrations.CreateModel(
            name='PoolLock',
