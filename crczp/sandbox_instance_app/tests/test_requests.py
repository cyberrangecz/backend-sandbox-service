...
class TestCleanupRequest:
    ...
    def test_create_cleanup_request_failed_already_cleaning(
        self, sandbox_finished, cleanup_request_started
    ):
        allocation_unit = sandbox_finished.allocation_unit
        self.assert_cleanup_request_failed(allocation_unit)

    def test_create_cleanup_request_force_already_cleaning(
    ...
    def test_get_cleanup_request_stages_state(
    ...
    def test_get_cleanup_request_stages_state_fail(
        self,
        cleanup_request,
        cleanup_stage_stack,
