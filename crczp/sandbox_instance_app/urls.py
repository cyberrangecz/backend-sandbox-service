...
urlpatterns = [
    ...
    path('pools/<int:pool_id>/cancel-queued', views.PoolCancelQueuedCreateView.as_view(),
         name='pool-cancel-queued'),
    path('pools/<int:pool_id>/force-cancel-allocation', views.PoolForceCancelAllocationCreateView.as_view(),
         name='pool-force-cancel-allocation'),
    path('pools/<int:pool_id>/force-cleanup', views.PoolForceCleanupCreateView.as_view(),
    ...
    # Sandbox allocation units (by-creator before <int:unit_id> to avoid conflict)
    path('sandbox-allocation-units/by-creator',
         views.SandboxAllocationUnitByCreatorListView.as_view(),
         name='sandbox-allocation-units-by-creator'),
    path('sandbox-allocation-units/by-age',
         views.SandboxAllocationUnitByAgeListView.as_view(),
         name='sandbox-allocation-units-by-age'),
